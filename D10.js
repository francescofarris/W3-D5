...
function deleteOne(str, removeFirst) {
  return removeFirst ? str.slice(1) : str.slice(0, -1)
}
console.log(deleteOne("come stai?", true))
...
console.log(onlyLetters("Numero di telefono: 3385255616"))

/* ESERCIZIO 6
  Crea una funzione chiamata "isThisAnEmail" che riceve una stringa come parametro e ritorna true se la stringa è un valido indirizzo email.
*/
const isThisAnEmail = (stringa) => {
  let atIndex = stringa.indexOf("@")
  let dotIndex = stringa.indexOf(".", atIndex + 1)
...
console.log(howManyDays("2025-02-21"))

/* ESERCIZIO 10
  Scrivi una funzione chiamata "isTodayMyBirthday" che deve ritornare true se oggi è il tuo compleanno, falso negli altri casi.
*/
const isTodayMyBirthday = (birthDate) => {
  const d = new Date(), b = new Date(birthDate)
  return d.getDate() === b.getDate() && d.getMonth() === b.getMonth()
}
console.log(isTodayMyBirthday("2001-12-15"))
...
const newestMovie = (movies) => movies.sort((a, b) => b.Year - a.Year)[0]
...
*/
const sumAllTheYears = () => movies.reduce((sum, movie) => sum + Number(movie.Year), 0)
console.log(sumAllTheYears())

/* ESERCIZIO 17
  Scrivi una funzione chiamata "searchByTitle" che riceve una stringa come parametro e ritorna i film nell'array "movies" fornito che la contengono nel titolo.
*/
const searchByTitle = (string) => movies.filter(movie => movie.Title.toLowerCase().includes(string.toLowerCase()))
...
const searchAndDivide = (string) => {
  const match = movies.filter(movie => movie.Title.toLowerCase().includes(string.toLowerCase()))
  const unmatch = movies.filter(movie => !movie.Title.toLowerCase().includes(string.toLowerCase()))
...
*/
const removeIndex = (index) => movies.filter((_, i) => i !== index)
...
const linkbackgroundColor = () => {
  document.querySelectorAll("a").forEach(a => a.style.backgroundColor = "red")
}
